...
import { OrderStatus } from '@tr-common/common';
...
it('returns a 201 with a valid inputs', async () => {
  const userId = global.generateId();
  // price for the real stripe api test case
  ...
  // expectations for the mock stripe service:
  ...
  // expectations for the real stripe api service:
